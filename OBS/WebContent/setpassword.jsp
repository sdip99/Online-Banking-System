				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card-box">
							...
							<br>
							<br>
							<form action="SavePassword.html" method="post"
								data-parsley-validate novalidate>

								<div class="form-group">
									<label for="emailAddress">New Password*</label> <input
										type="password" name="newpassword" parsley-trigger="change"
										required placeholder="Enter New Password" class="form-control"
										id="emailAddress">
								</div>
								<div class="form-group">
