		...
		<div id="sidebar-menu">
			<ul>
				...
				<li class="has_sub"><a href="#" class="waves-effect"><i
						class="ti-pencil-alt"></i> <span> MiniStatement </span> </a>
					<ul class="list-unstyled">
						<li><a href="miniStatement.html">View Ministatement</a></li>
						<li><a href="detail.jsp">Detailed Statement</a></li>

					</ul></li>

				<li class="has_sub"><a href="#" class="waves-effect"><i
						class="ti-hand-point-right"></i> <span> Fund Transfer </span> </a>
					<ul class="list-unstyled">
						<li><a href="addPayee.jsp">Add Payee</a></li>
						<li><a href="showAllPayee.html">Transfer Fund</a></li>
						<li><a href="viewTransactions.html">View Transactions</a></li>

					</ul></li>

				<li class="has_sub"><a href="#" class="waves-effect"><i
						class="ti-light-bulb"></i><span> Track Services </span> </a>
					<ul class="list-unstyled">
						<li><a href="acceptServiceId.jsp">Track Using Service Id</a></li>
						<li><a href="trackAllServices.html">Track All Services</a></li>
				...
				<!--   <li class="has_sub">
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="ti-bar-chart"></i><span class="label label-pink pull-right">11</span><span> Charts </span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect active"><i class="ti-widget"></i><span> Layouts </span></a>
                                <ul class="list-unstyled">
                                    ...
                                    <li class="active"><a href="layout-header_2.html"> Header style</a></li>
                                </ul>
                            </li>
