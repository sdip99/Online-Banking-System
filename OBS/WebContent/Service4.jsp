				...
				<div class="row">
					<div class="col-lg-12">
						<div class="p-20">
								...
								<table class="table m-0">
									...
									<tbody>
										<c:forEach items="${list}" var="transaction">
											<tr>
												<td><a
													href="displayTracker.html?id=${transaction.service_id}"><c:out
															value="${transaction.service_id}" /></a></td>

												<td><c:out value="${transaction.serviceDescription}" /></td>
												<td><c:out value="${transaction.serviceRaisedDate}" /></td>
												<td><c:out value="${transaction.serviceIssueDate}" /></td>
												<td><c:out value="${transaction.serviceStatus}" /></td>
											</tr>
										</c:forEach>
							...
							<br>
							<br> <a href="user_home.jsp"><button
