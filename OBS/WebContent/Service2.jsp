		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="p-20">
							<c:if test="${trackid!=null}">
												 YOUR REQUEST FOR CHEQUE BOOK HAVE BEEN PROCESSED WITH THE SERVICE ID
												 <a href="displayTracker.html?id=${trackid}">${trackid}</a>
								<%--<table class="table m-0">
													...
													<tbody>
													<c:forEach items="${miniList}" var="transaction">
														<tr>
															<td><c:out value="${transaction.transactionId}" /></td>
															<td><c:out value="${transaction.transactionDescription}" /></td>
