	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="page-title">Online Transactions</h4>
						<ol class="breadcrumb">
						...
						<div class="p-20">
							<c:if test="${fList!=null}">
								<table class="table m-0">
									...
									<tbody>
										<c:forEach items="${fList}" var="transaction">
											<tr>
												<td><c:out value="${transaction.fId}" /></td>
												<td><c:out value="${transaction.sourceId}" /></td>
												<td><c:out value="${transaction.destId}" /></td>
												<td><c:out value="${transaction.dot}" /></td>
												<td><i class="fa fa-inr"><c:out
															value="${transaction.tamount}" /></i></td>
											</tr>
										</c:forEach>
