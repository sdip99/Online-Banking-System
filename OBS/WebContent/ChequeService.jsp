				...
				<div class="row">
					<div class="col-lg-12">
						<h4 class="m-t-0 header-title">
							<b>Cheque Book Details</b>
						</h4>
						<div class="p-20">
							<form action="SaveChequeDetails.html">

								<table class="table m-0" align="center" border="1">

									<thead align="right">
										<tr>
											<th>Please verify your details</th>
										</tr>
									</thead>
									<tbody align="center" border="1">
										<tr>
											<td>${details.accountId}<br> ${details.cust_name}<br>
												${details.address} <br>${details.email}<br>
												${details.phone_no}
											</td>
										</tr>
									</tbody>
									...
									<tr>
										<td colspan="2"><button type="submit"
												...
												Process Cheque request</button></td>
									</tr>
								</table>
